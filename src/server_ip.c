...
pthread_rwlock_t ip_rwlock                  = PTHREAD_RWLOCK_INITIALIZER;    // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
char             shared_ip[INET_ADDRSTRLEN] = "";                            // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
